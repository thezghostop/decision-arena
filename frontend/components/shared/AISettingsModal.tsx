...
const PROVIDERS: {
...
}[] = [
  {
    ...
    desc: "Use whatever the server is configured with",
    icon: "cloud",
  },
  {
    id: "ollama",
    label: "Ollama (local)",
    desc: "Run models privately on your machine",
    icon: "local",
  },
  {
    id: "groq",
    label: "Groq  (BYOK)",
    desc: "Blazing-fast cloud inference, your key",
    icon: "cloud",
  },
  {
    id: "openai",
    label: "OpenAI (BYOK)",
    desc: "GPT-4o with your own API key",
    icon: "cloud",
  },
  {
    id: "gemini",
    label: "Gemini (BYOK)",
    desc: "Google Gemini 2.5 Flash, your key",
    icon: "cloud",
  },
];
