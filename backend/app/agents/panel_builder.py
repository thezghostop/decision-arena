...
EXPERT_LIBRARY: list[AgentConfig] = [
    ...
    AgentConfig(
        ...
        icon="🫶",
        color="#FB7185",
        bias="What they'd actually tell you over coffee, cutting through overthinking, calling out excuses and people-pleasing",
    ...
    AgentConfig(
        ...
        icon="🛡️",
        color="#0891B2",
        bias="Family stability, safety nets, long-term security, risk-aversion, what could go wrong for the people who depend on you",
